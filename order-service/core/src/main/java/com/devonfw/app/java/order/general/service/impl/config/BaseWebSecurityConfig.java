...
//        .csrf().requireCsrfProtectionMatcher(new CsrfRequestMatcher()).and()	//authentication login form
        .csrf().disable().httpBasic().and() //to use h2 console in internet //authentication http basic //podstawowe uwierzyteleninie hasla
